            ...
            <Card.Body>
                <div className="w-100" style={{ fontSize: '0.8em' }}>
                    <div className="w-100 d-flex">
                        ...
                        <Col className="text-end px-3 py-2">{on ? <i class="bi bi-caret-up text-primary" onClick={() => setOn(false)}></i> 
                        : <i className="bi bi-caret-down text-primary" onClick={() => setOn(true)}></i>}</Col>
                    </div>
                    <Collapse in={on}>
                        <div>
